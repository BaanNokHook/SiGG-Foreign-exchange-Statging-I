...
namespace moneycpp
{
      ...
      inline constexpr bool operator<(country_unit const & lhs, country_unit const const & rhs) noexcept 
      {
...
#ifdef HAS_COUNTRY_COUNTRY_AND_CURRENCY_DB   
